...
% \subsubsection{Effectiveness and Efficiency of LADR}
...
% Is LADR applicable across different single-representation dense retrieval models,
...
% LADR is a novel retrieval technique that establishes a new parito
...
% it introduces, such as the number of neighbors 𝑘 k and the batch size 𝑏 b?
